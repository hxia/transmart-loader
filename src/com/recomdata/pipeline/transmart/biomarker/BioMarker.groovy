...
abstract class BioMarker {
    ...
    Properties props
	Sql biomart
	String organism, geneSource, geneType, biomartSchemaName

    abstract void insertGenes(StringBuffer sb)

    abstract void loadGenes(File gene)
...
//	}
	...
	abstract void loadGeneOntologyGenes(File gene, Map geneId)
...
//	}
	...
	abstract void loadPathways(File pathway, String source)
...
//	}
	...
	abstract void insertBioMarker(String geneSymbol, String description, String geneId, String source, String markerType)
...
//	}
    ...
    abstract  boolean isBioMarkerExist(String geneId, String markerType)
...
//	}
    ...
    void setGeneSource(String geneSource){
